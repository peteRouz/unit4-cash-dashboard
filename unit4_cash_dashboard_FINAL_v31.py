...
with col1:
    ...
    bar_w = 0.35
    ax_cf.bar(x, inflow, bar_w, color=inflow_colors, edgecolor='black', linewidth=0.5, label='Inflow')
    ax_cf.bar(x, outflow, bar_w, color=outflow_colors, edgecolor='black', linewidth=0.5, label='Outflow')
